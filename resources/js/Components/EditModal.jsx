...
const EditModal = ({ showModal, handleClose, rowData, updateData }) => {
    ...
    useEffect(() => {
        if (rowData) {
            setNome(rowData.original?.nome || "");
            setIdade(rowData.original?.idade || "");
            setTelefone(rowData.original?.telefone || "");
            setCep(rowData.original?.cep || "");
            setEstado(rowData.original?.estado || "");
            setCidade(rowData.original?.cidade || "");
            setRua(rowData.original?.rua || "");
            setNumero(rowData.original?.numero || "");
            setComplemento(rowData.original?.complemento || "");
        }
    }, [rowData]);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (!response.ok) {
                ...
                updateData(id, contatoAtualizado);
